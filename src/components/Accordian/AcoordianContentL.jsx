...
export default function AcoordianContentL({image, heading, subHeading, paragraph}) {
  return (
    <div className="z-2 grid md:grid-cols-2 m-10 pt-20 pb-20 relative">
      ...
      <div className="rounded-full md:block hidden bg-black w-[250px] h-[1000px] absolute right-[-200px] bottom-0"></div>
