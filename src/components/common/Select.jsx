...
export default function Select({ onChange, handler, options }) {
  ...
  return (
    <select onChange={(e) => handler(e.target.value)} className='m-2 bg-green1 rounded-lg border-none text-white h-[40px] hover:bg-[#000300] focus:border-t-black ml-2 mr-2'>
