...
export default function CardPricing({ category, pricing, features, onMouseEnter, onMouseLeave }) {
  return (
    ...
    className="card card-back m-5 p-5 flex flex-col justify-center items-center text-center bg-[#0D1117] shadow-[#12a174] w-[200px] h-full md:w-[300px] rounded-2xl shadow-lg transition-transform duration-300 hover:shadow-2xl hover:scale-105 hover:shadow-inner-[#00df9a]">
